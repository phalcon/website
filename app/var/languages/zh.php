<?php
    ...
    $messages = array(
        ...
        'testimonials_1'                  => "Phalcon团队，你们好！ 我有一个项目是用Phalcon开发的。 它是 Guitarama (<a href='http://guitarama.ru'>http://guitarama.ru</a>) - guitars tabs and chords catalog。网站主要面向俄语用户，并且网站也是俄语的， 但我希望这不会妨碍我们了解大部分页面。在2013年一月份的早些时候，在一个新平台上我们重新推出了这个网站，一直在稳步增长中。目前的日均访问量：~1500UV，~5000PV。该网站运行在一个老物理服务器上1хP4-3GHZ，4GB RAM。再次感谢你们的努力工作 :) Michael",
        'testimonials_2'                  => "Hello, Phalcon团队。  我想和你们一起分享一些我们使用Phalcon成功的案例：<a href='http://kolesa.kz'>http://kolesa.kz</a> and <a href='krisha.kz'>krisha.kz</a>。 在哈沙克斯坦是访问最高的网站之一，在独联体里面排名Top-10。 两个网站都是使用 Phalcon\Mvc\Micro写的RESTful API。 其中一个的最高请求达到400次/秒，但这不是极限。在迁移到Phalcon后，相应时间减少了，CPU和内存消耗减少了，同样开发时间也减少了。我们将继续在我们的新项目里使用Phalcon。感谢你们如此棒的工作。 此致， Nikita Vershinin, Lead Developer, Kolesa.kz and krisha.kz",
        ...
        'testimonials_5'                  => "嗨，大家好，我用Phalcon写了一个简单的URL缩短服务。真是太令人惊奇了！ <a href='https://github.com/blackbunny/Url-Shortener'> https://github.com/blackbunny/Url-Shortener</ A>演示<a href='http://u.dolap.co'> http://u.dolap.co</ A> :) Murat Küçükosman ",
