<?php
    ...
    $messages = [
        'download'                        => 'Katebase to',
        'documentation'                   => 'Eggrafa',
        'forum'                           => 'Foroum',
        'blog'                            => 'Blabla',
        'support'                         => 'Boitheia',
        'donate'                          => 'Dwrees',
        'store'                           => 'Magazi',
        'github'                          => 'To GitHub',
        'phalcon_description'             => "To <strong>Phalcon</strong> einai ena framework gia dimiourgeia istoselidwn pou prosferei <a href=':1:'>ypsili apodosi</a> kai xamili xrisimopoiisi mnimis",
        'the_fastest'                     => 'To pio grigoro',
        'php_framework'                   => 'PHP Framework',
        'try_online'                      => 'Dwkimaste to',
        'see_screencasts'                 => 'Des Screencasts',
        'everything_you_need_upper'       => 'OTI XREIAZESTE',
        'full_mvc_applications'           => 'Full MVC efarmoges',
        'single_module'                   => 'Ena-Module',
        'multi_module'                    => 'Poly-Module',
        'micro_applications'              => 'Mikro efarmoges',
        'orm'                             => 'O-R-M',
        'transactions'                    => 'Synallages',
        'behaviors'                       => 'Diagwges',
        'relations'                       => 'Sxeseis',
        'phql'                            => 'P-H-Q-L',
        'events'                          => 'Symbanta',
        'validations'                     => 'Egkriseis',
        'hydration'                       => 'Ydrosomething',
        'logging'                         => 'Arxeia',
        'profiling'                       => 'Profil',
        'sharding'                        => 'Klasimo',
        'odm_for_mongo'                   => 'ODM gia Mongo',
        'template_engine_volt'            => 'Template mixani (Volt)',
        'di_ioc'                          => 'DI/I-O-C',
        'events_management'               => 'Diaxeirisi Symbantwn',
        'encryption'                      => 'Kryptografeia',
        'http_request'                    => 'HTTP Zitiseis',
        'http_response'                   => 'Apantiseis',
        'http_cookies'                    => 'Koulourakia',
        'escaping'                        => 'Apodraseis',
        'filtering'                       => 'Filtra',
        'forms_builder'                   => 'Dimiourgia Forms',
        'forms_validation'                => 'Egkriseis formes',
        'flash_messages'                  => 'Flash mynimata',
        'cache'                           => 'Koubas',
        'pagination'                      => 'Selidopoiisi',
        'annotations'                     => 'Annotations',
        'security'                        => 'Asfaleia',
        'translations'                    => 'Metafraseis',
        'assets_management'               => 'Assets Diaxeirisi',
        'universal_auto_loader'           => 'Pagkosmios Auto-Loader',
        'cli'                             => 'C-L-I',
        'phalcon_forum_upper'             => 'PHALCON SYZITISI',
        'stack_overflow_upper'            => 'STACK PLYMIRA',
        'github_upper'                    => 'G-I-T-H-U-B',
        'email_us_upper'                  => 'STEILTE MYNIMA',
        'services_upper'                  => 'YPIRESIES',
        'consulting_upper'                => 'SYMBOULES',
        'requirements_analysis'           => 'Analysi Apaitisewn',
        'implementation'                  => 'Efarmogi',
        'ongoing_support'                 => 'Ongoing Ypostiriksi',
        'read_more'                       => 'Diabaste parapanw',
        'hosting_upper'                   => 'FILOKSENEIA',
        'phalcon_can_be_installed'        => 'To Phalcon mporei na egkastathei se',
        'main_upper'                      => 'KYRIWS',
        'consulting'                      => 'Symboules',
        'hosting'                         => 'Filokseneia',
        'support_upper'                   => 'YPOSTIRIKSI',
        'forum_community'                 => 'Forum / Filarakia',
        'stack_overflow'                  => 'Stack PLymira',
        'issue_tracker'                   => 'Issue Tracker',
        'get_involved_upper'              => 'SYNERGASTEITE',
        'team'                            => 'Omada',
        'about'                           => 'Peri',
        'roadmap'                         => 'To mellon',
        'donate_to_phalcon'               => 'Dwriste sto Phalcon:',
        'or'                              => 'i',
        'twitter'                         => 'Poulakia',
        'facebook'                        => 'FaceBiblio',
        'google_plus'                     => 'Google +',
        ...
        'download_compilation_11'         => '1. To create the extension from C source follow the next steps:',
        ...
        'download_opensuse_1'             => "There is package available <a href=':1:'>here</a> (thanks to <a href=':2:'>Mariusz Łączak</a>)",
        'download_freebsd'                => 'FreeBSD',
        'download_freebsd_1'              => 'A port is available for FreeBSD. Just only need these simple line commands to install it:',
        ...
        'download_windows_note'           => 'We highly recommend you to use the latest version of PHP corresponding to our DLLs, so as to take advantage of the full feature set of Phalcon.',
