<head>
    ...
    {# #TODO
    <meta name="twitter:site:id" content="00000000000000" />
    ...
    {{ get_title() }}
    <meta name="keywords" content="php, phalcon, phalcon php, php framework, faster php framework, php compiled, zephir">

    <link href="//netdna.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap.min.css" rel='stylesheet' type='text/css'>

    <!--<link href="{{ cdn_url }}css/style.css" rel='stylesheet' type='text/css'>-->
    <link href="{{ cdn_url }}css/src/highlight.js.css" rel='stylesheet' type='text/css'>
    <link href="{{ cdn_url }}css/src/flags.css" rel='stylesheet' type='text/css'>
    <link href='//fonts.googleapis.com/css?family=Open+Sans:700,400' rel='stylesheet' type='text/css'>

    {% include 'partials/flags.volt' %}
