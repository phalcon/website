...
<section class="team">
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="{{ cdnUrl }}images/team/andres.jpg"
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="{{ cdnUrl }}images/team/eduar.jpg"
                 alt="Eduar Carvajal"
                 style="width: 102px;"
                 class="img-circle"/>
        </div>
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="{{ cdnUrl }}images/team/nikos.jpg"
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="{{ cdnUrl }}images/team/nikolay.jpg"
    ...
    <div class="row">
        <div class="col-lg-2">
            <img src="{{ cdnUrl }}images/team/serghei.png"
