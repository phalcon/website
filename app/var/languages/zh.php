<?php
    ...
    $messages = array(
        ...
        'download_opensuse_1'             => "这里有另外一个包，点击<a href=':1:'>这里</a> (感谢 <a href=':2:'>Mariusz Łączak</a>)",
        'download_freebsd'                => 'FreeBSD',
        'download_freebsd_1'              => 'FreeBSD下，只需要简单的几行命令即可安装它：',
        ...
        'requirements_analysis_1'         => '最大的一个问题，开发人员面临的很多项目都没有进行充分的需求调研。因此，往往客户的要求完全不同于开发人员理解和其随后提供的开发结果。',
        ...
        'sponsors_2'                      => '此外，用户可能希望实现某些很受欢迎或者很复杂的功能，但通常需要很长时间才能完成。按照我们正常的费用就可以满足这样的请求。',
        'contact'                         => '联系',
        'contact_1'                       => "随时<a href=':1:'>联系我们</a>讨论您的需求，我们将根据项目大小提供一个最适合您需求和预算的解决方案。",

        'phalcon_team'                    => 'Phalcon团队',
        'team_andres_1'                   => 'Andres并不是开源项目里的陌生人。在过去的九年里，他已经设计和发布许多PHP框架、参与web开发是他的酷爱。',
        'team_andres_2'                   => "一个TR35赢家，Andres的主要任务是在选择和实施或使用正确的工具来完成工作,主要集中在性能上。因此在2011年，一个新的想法是在工作中诞生；为PHP开发人员建立一种新的框架，一个侧重于高可用性、拥有丰富功能和高性能的框架。",
        ...
        'team_nikos_3'                    => '他是一个热心的测试驱动开发(TDD)支持者和总是试图100% c覆盖测试他的代码。',
        'team_nikos_4'                    => "Nikos依然关心新的和创新技术。他加入核心团队后，主要任务涉及NFRs的协调和bug修复，测试，文档以及孵化器。Nikos还负责维护Windows DLL项目，并尽可能提供支持。",
        ...
        'get_involved'                    => '加入我们',
        'about_description_1'             => "神奇的项目需要一个神奇的您。我们可能还不知道您，但我们认为您会是一个非常适合创建更好的网络的人。总之，我们已经准备好改变世界！在Phalcon里，我们正在构建一个新一代的PHP框架，我们想给您一个令人惊异的具有高性能的，使您开发更愉悦，更容易的开发框架。",
        'about_description_2'             => '我们希望您能像我们一样享受Phalcon。我们的大门是永远打开等待您合作像这样的项目：',
        ...
        'tests'                           => '测试',
        'about_tests_1'                   => "没有任何软件是完全没有bug的，如果您发现任何一个，请立即告诉我们。 我们有一个比<a href=':1:'>8000测试</a>更严格的测试系列。 但是，仅仅单元测试是不够的。 帮助我们改进我们的测试套件，您可以通过添加更多的测试或改善当前的某个测试。每个测试都使得框架更加稳定有助于避免错误重新产生或破坏目前正常运行的功能。框架的整体稳定性，在很大程度上取决于我们的测试。",
        ...
        'evangelism'                      => '传道者',
        'about_evangelism_1'              => "传道者，这里仍然有很多人不知道Phalcon的存在，虽然它确实有效。我们确信，当许多开发者了解Phalcon是什么和可以如何帮助他们后，他们将受益于Phalcon。如果您知道任何PHP活动/会议，并且您想做一个关于Phalcon项目的演讲，我们会全力支持。谁不希望了解革命性的PHP开发工具呢？",
        'share_your_experiences'          => '分享您的经验',
        'about_share_experiences_1'       => "不要害羞，，请在社区自由分享Phalcon对您非常有用的。如果Phalcon对您而言非常好，让我们一起分享到社区。此外，请讨论哪些组件需要额外的工作才可以让您更容易的使用它，可以获得哪些好处等。虽然不是所有的功能都可以立即实现，但您提出的新功能可以极大地帮助我们改造未来的项目。您的反馈将有助于我们所有人。",
        'about_blog_1'                    => "如果您喜欢写作，记住<a href=':1:'>我们的博客</ a>是可以公开发布由您编写的教程。如果您有自己的博客和有写一些关于Phalcon的文章，我们也可以发布在我们的社交网络上，以达到最高您的知名度。如果您的博客文章使用非英语的其他语言，我们会分享它，并可能翻译它。如果您知道某些PHP相关博客的听从会对Phalcon感兴趣，请让我们知道。",
        'donations_sponsoring'            => 'Donations / Sponsoring',
        'about_sponsoring_1'              => "我们是一个小型但高效的核心开发团队，我们试着花尽可能多的时间到Phalcon项目上。对于这个项目我们所有的激情都是让她每天都变得更好。Phalcon是一个开源软件，需要志愿者的不断努力使其不断进化。您可以通过捐赠或资助以帮助我们积极开发这个项目。更多的时间和资源致力于这个项目意味着项目更活跃，更多的改进，更好的支持和更多的神奇功能。",
        'social_networks'                 => '社交网络',
        'about_social_networks_1'         => "Phalcon每天都在不断发展，希望通过我们的努力能够使它变得更好。现在社交网络是我们生活的一部分，我们通过它们与他人互动。在您的社交圈内，分享您的Phalcon经验将极大提高Phalcon的知名度。越来越多的人将加入我们的社区组织，从而使其功能更强大，更丰富的功能、更受欢迎。如同“+1”，分享我们在每个社交网络上的发帖，参与讨论关于这些帖子。人们会通过你的互动发现Phalcon，并感谢你！",
