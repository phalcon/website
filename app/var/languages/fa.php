<?php
    ...
    $messages = array(
        ...
        'google_plus'                     => 'G+',
        'vimeo'                           => 'Vimeo',
        'amazing_contributors'            => 'برترین مشارکت کنندگان ما',
        ...
        'download_ubuntu'                 => 'برای نصب فالکون بر روی اوبونتو باید از مراحل زیر پیروی کنید:',
        'download_ubuntu_1'               => 'اگر شما apt-add-repository را ندارید، دستور زیر را اجرا کنید:',
        'download_note'                   => 'فالکون افزونه (extention) است که به زبان C نوشته شده است، بنابراین باید پرونده باینری متناسب با پلتفرم خود را دریافت کنید و یا اینکه با استفاده از کدهای منبع آن را کامپایل کنید.',
        ...
        'download_freebsd_1'              => 'یک خروجی برای FreeBSD در دسترس می‌باشد. تنها تعدادی فرمان برای نصب آن نیاز است:',
        ...
        'download_windows_note'           => 'پیشنهاد ما استفاده از آخرین نگارش PHP متناسب با پرونده‌های DLL است، در این صورت شما می تواند از تمام ویژگی‌های فالکون بهره ببرید.',
        ...
        'download_vagrant_1'              => "<a href=':1:'>Vagrant</a> ابزاری بسیار عالی برای ایجاد و پیکره بندی محیط گسترش سبک، تجدید پذیر (استفاده مجدد) و قابل جابجایی می‌باشد.",
        'download_vagrant_2'              => "برای تست یا گسترش با استفاده از فالکون بر روی یکی از محیط‌های از پیش پیکره‌بندی شده، از یکی از موارد زیر استفاده کنید.",
        'download_box_1'                  => "Box #1",
        'download_box_2'                  => "Box #2",
        'download_box_user_pass'          => "کاربر MySQL: :1: رمزعبور: :2:",
        'download_box_doc_root'           => "مسیر پرونده‌ها: :1:",
        'download_examples'               => "نمونه‌های پیش نصب‌شده",
        'download_examples_1'             => "نمونه‌های زیر به طور پیش‌فرض بر روی هر یک از vargant box نصب شده است:",

        'consulting_header'               => "ما با <a href=':1:'>LEZGRO</a> مشارکت داریم، این کمپانی به طور ویژه بر روی نرم‌افزارهای وب و موبایل فعالیت دارد، و در رساندن برنامه‌هایی به دست مشتریانش که با استفاده از فالکون نوشته شده اند بسیار فعال می باشد.",
        'consulting_lezgro_1'             => "<a href=':1:'>LEZGRO</a> به خاطر اینکه فالکون را به عنوان هسته تکنولوژی انتخاب می کنید، تبریک می گوید.",
