...
<section class="about">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('translations') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('tests') }}</h3>
                <p>{{ locale.translate('about_tests_1', 'https://travis-ci.org/phalcon/cphalcon') }}</p>
            </div>

            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('screencasts') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('evangelism') }}</h3>
                <p>{{ locale.translate('about_evangelism_1') }}</p>
            </div>

            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('sample_applications') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('blog') }}</h3>
                <p>{{ locale.translate('about_blog_1', 'http://blog.phalconphp.com') }}</p>
            </div>

            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('share_your_experiences') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('social_networks') }}</h3>

                <p>{{ locale.translate('about_social_networks_1') }}</p>
                <p>{{ locale.translate('about_social_networks_2') }}</p>

                <ul class="dash-list">
                    <li><a href="http://twitter.com/phalconphp">{{ locale.translate('follow_on_twitter') }}</a></li>
                    <li><a href="http://www.facebook.com/pages/Phalcon/134230726685897">{{ locale.translate('facebook_page') }}</a></li>
                    <li><a href="https://plus.google.com/102376109340560896457">{{ locale.translate('google_plus_page') }}</a></li>
                    <li><a href="http://blog.phalconphp.com">{{ locale.translate('official_blog') }}</a></li>
                    <li><a href="http://github.com/phalcon/cphalcon">{{ locale.translate('star_on_github') }}</a></li>
                </ul>

            </div>

            <div class="col-lg-6">
                <h3 class="text-uppercase">{{ locale.translate('donations_sponsoring') }}</h3>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="text-uppercase">{{ locale.translate('thank_you') }}</h3>

                <p>{{ locale.translate('about_thank_you_1') }}</p>

                <p><span class="strong">{{ locale.translate('flying_with_phalcon') }}</span></p>
            </div>
        </div>
    </div>
</section>
