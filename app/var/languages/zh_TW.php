<?php
    ...
    $messages = array(
        ...
        'team_nikolay_5'                  => "他的貢獻包括：一個俄語的鏡像網站(<a href=':1:'>http://www.phalconphp.ru</a>)、一個俄語文件的鏡像(<a href=':2:'>http://docs.phalconphp.ru</a>)、持續改變及修正英文文件還有一個社交網路Vkontakte的群組(<a href=':3:'>http://vk.com/phalconphp</a>)。",
