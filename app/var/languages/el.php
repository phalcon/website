<?php
    ...
    $messages = array(
        ...
        'hosting_description'             => 'Το Phalcon μπορεί να εγκατασταθεί σε οποιοδήποτε κομπιούτερ με την προυπόθεση ότι έχετε πρόσβαση SSH root (ή sudo). Παρακάτω θα βρείτε τη λίστα από ευυπόληπτες εταιρείες που προσφέρουν αυτές τις υπηρεσίες:',
