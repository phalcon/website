<?php
    ...
    $messages = array(
        ...
        'download_ubuntu'                 => 'Um Phalcon auf Ubuntu zu installieren, müssen die folgenden Schritte ausgeführt werden:',
        'download_ubuntu_1'               => 'Wenn das apt-add-Respository fehlt, führe den folgenden Befehl aus:',
        ...
        'about_description_2'             => "Wir hoffen, dass Ihnen Phalcon genau so gefällt wie uns. Wir begrüßen jede Art von Beteiligung und Hilfe! <strong>Sie müssen kein C-Entwickler sein, um Phalcon zu helfen!</strong> Es gibt viele weitere Bereiche, in welchen Beiträge geleistet werden können:",
        ...
        'about_documentation_1'           => "Das Repository dieser Website findet sich bei <a href=':1:'>GitHub</a>. Wir benutzen <a href=':2'>readthedocs</a>, um unsere Dokumentation zu verwalten.<br /><br />Wir begrüßen jede Verbesserung unserer Dokumentation, sodass Sie nur die Repository klonen und eine Anfrage senden müssen!<br /><br />Es wäre schön, wenn Sie Entwicklern, die der englischen Sprache nicht mächtig sind, durch die Übersetzung der Inhalte in eine andere Sprache helfen könnten!",
