<?php
    ...
    $messages = array(
        ...
        'the_fastest_php_framework'       => 'הספריית PHP המהירה ביותר',
        'try_online'                      => 'נסה אותה אונליין',
        'see_screencasts'                 => 'ראה תמונות דוגמא',
        'everything_you_need_upper'       => 'כל מה שאתה צריך',
        'full_mvc_applications'           => "Full <a href=':1:'>MVC</a> applications",
        'single_module'                   => 'מודול בודד',
        'multi_module'                    => 'מולטי-מודול',
        'micro_applications'              => 'מיקרו אפליקצייה',
        'orm'                             => 'ORM',
        'transactions'                    => 'העברות',
        'behaviors'                       => 'התנהגויות',
        'relations'                       => 'קשרים',
        ...
        'template_engine_volt'            => 'מנוע טמפלאט (VOLT)',
        'di_ioc'                          => 'DI/IOC',
        'events_management'               => 'ניהול אירועים',
        'encryption'                      => 'קידוד',
        ...
        'escaping'                        => 'בריחה',
        'filtering'                       => 'פילטרים',
        'forms_builder'                   => 'בונה טפסים',
        'forms_validation'                => 'אימות',
        'flash_messages'                  => 'הודעות הבזק',
        'cache'                           => 'מטמון',
        'pagination'                      => 'מיספור דפים',
        'annotations'                     => 'הַגָהָה',
        'security'                        => 'אבטחה',
        'translations'                    => 'תירגומים',
        'assets_management'               => 'ניהול נכסים',
        'universal_auto_loader'           => 'טוען אוטומטי אוניברסלי',
        'cli'                             => 'CLI',
        'phalcon_forum_upper'             => 'פאלקון פורום',
        'stack_overflow_upper'            => 'סטאק אוברפלו',
        'github_upper'                    => 'גיטהאב',
        'email_us_upper'                  => 'כתוב לנו מייל',
        'services_upper'                  => 'שירותים',
        'consulting_upper'                => 'מתן יעוץ',
        'requirements_analysis'           => 'ניתוח דרישות',
        'implementation'                  => 'יישום',
        'ongoing_support'                 => 'תמיכה מתמשכת',
        'read_more'                       => 'קרא עוד',
        'hosting_upper'                   => 'אירוח',
        'phalcon_can_be_installed'        => 'יש אפשרות להתקין את פאלקון ב',
        'main_upper'                      => 'ראשי',
        'consulting'                      => 'יעוץ',
        'hosting'                         => 'אירוח',
        'support_upper'                   => 'תמיכה',
        'forum_community'                 => 'פורום / קהילה',
        'stack_overflow'                  => 'סטאק אוברפלו',
        'issue_tracker'                   => 'מעקב אח תיעוד',
        'get_involved_upper'              => 'הצטרף',
        'team'                            => 'צוות',
        'about'                           => 'אודות',
        'roadmap'                         => 'מפת דרך',
        'donate_to_phalcon'               => 'תרום לנו',
        'or'                              => 'או',
        'twitter'                         => 'טוויטר',
        'facebook'                        => 'פיסבוק',
        'google_plus'                     => 'גוגל פלוס',
        'vimeo'                           => 'ווימו',
        'amazing_contributors'            => 'התומכים הנהדרים שלנו',

        'download_phalcon'                => 'הורד את פאלקון',
        'download_linux'                  => 'לינוקס/יוניקס/מאק',
        'download_windows'                => 'ווינדוס DLL',
        'download_developer_tools'        => 'כלים למפתחים',
        'download_ide_stubs'              => 'ספחי IDE',
        'download_ubuntu'                 => 'איך להתקין את פאלקון ב- Ubuntu , אנא עקוב אחר הצעדים',
        'download_ubuntu_1'               => 'במידה וחסר לך - apt-add-repository אנא הרץ את הפקודה:',
        'download_note'                   => 'פאלקון היא הארכה של שפת C, אנא הורד את הבינארי קוד לפלטרופמה שלך או לקאמפל אותה מהקוד מקור.',
        'download_compilation'            => 'אוסף',
        'download_compilation_1'          => 'במערכות לינוקס מאוד קל לקאמפל ולהתקין את התוספת מהקוד מקור.',
        'download_requirements'           => 'דרישות',
        'download_requirements_1'         => 'צריך להתקין כמה חבילות לפני ההמשך:',
        'download_requirements_2'         => 'PHP 5.x משאבי פיתוח',
        'download_requirements_3'         => 'מכווץ GCC',
        'download_compilation_11'         => '1. כדי ליצור את ההרחבה מ- C source אנא עבור על הצעדים הנל:',
        'download_compilation_12'         => '2. הוסף את ההרחבה לקובץ php.ini במחשבך:',
        'download_compilation_13'         => '3. לבסוף, הפעל מחדש את השרת',
        'download_debian'                 => 'דאביאן',
        'download_debian_1'               => "יש מאגר המוצע באדיבות <a href=':1:'>FortRabbit</a> <a href=':2:'>לחץ כאן</a>",
        'download_debian_2'               => 'לההרחבה קוראים php5-phalcon',
        'download_arch'                   => 'Arch Linux',
        'download_arch_1'                 => "יש חבילת בנייה ל-ArchLinux מוכנה להורדה <a href=':1:'>לחץ כאן</a>",
        'download_opensuse'               => 'OpenSUSE',
        'download_opensuse_1'             => "יש חבילה מוכנה להורדה <a href=':1:'>לחץ כאן</a> (תודות ל-<a href=':2:'>Mariusz Łączak</a>)",
        ...
        'download_windows_installation'   => 'התקנה',
        ...
        'download_windows_guides_xampp'   => 'התקן על גבי XAMPP',
        'download_windows_guides_wamp'    => 'התקן על גבי WAMP',
        'download_windows_alpha'          => 'גירסאות אלפה/בטה',
        'download_source_code'            => "קוד מקור: <a href=':1:' target='_download' title='GitHub Repo'>github</a>",
        'download_source_code_switch'     => "קוד מקור (אנא עבור לענף הרלוונטי): <a href=':1:' target='_download' title='GitHub Repo'>github</a>",
        'download_no_alpha_beta'          => 'כרגע לא זמינים הגירסאות אלפה/בטה',
        'download_windows_older'          => 'גירסאות ישנות יותר',
        ...
        'download_devtools_docs'          => "מסמכי תיעוד: <a href=':1:'>כלים למפתחי פאלקון</a>",
        'download_devtools_composer'      => 'התקן באמצעות Composer',
        ...
        'sample_applications'             => 'אפליקציות לדוגמא',
        ...
        'share_your_experiences'          => 'שתף את הנסיון שלך',
        ...
        'donations_sponsoring'            => 'תמיכה / תרומות',
        ...
        'follow_on_twitter'               => 'עקוב אחרינו בטוויטר',
        'facebook_page'                   => 'דף פייסבוק',
        'google_plus_page'                => 'דף גוגל+',
        'official_blog'                   => 'בלוג רשמי',
        'star_on_github'                  => 'התחל את הפרוייקט ב-Github',
        'thank_you'                       => 'תודה רבה',
        ...
        'flying_with_phalcon'             => 'תודה שאתם עפים עם פאלקון! &lt;3',
        ...
        'hosting_amazon_ec2_title'        => 'אמאזון EC2',
        ...
        'support_download_page'           => "הורד את הדף",
        ...
        'support_phalcon_forum'           => "פאלקון פורום",
        'support_forum_1'                 => "אתם יכולים לשאול שאלות ב- <a href=':1:'>פורום שלנו</a>",
        ...
        'support_reporting_a_bug'         => "דווח על באג",
