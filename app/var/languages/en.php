<?php
    ...
    $messages = array(
        ...
        'tests'                           => 'Tests',
        'about_tests_1'                   => "No software is free of bugs, if you find out any, please do not hesitate to tell us. We have a testsuite with more than <a href=':1:'>8000</a> tests. However, unit-tests are never enough. Help us to improve our testsuite by adding more tests or improve the current ones. Every added test makes the framework more stable and helps with avoiding the reintroduction of bugs or breaking something that is currently working. The overall stability of the frameworks highly depends on our tests.",
