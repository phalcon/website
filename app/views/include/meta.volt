...
<meta name=generator content="{{ config.get('app').get('name', 'Phalcon Framework') }} Website">
<meta name="application-name" content="{{ config.get('app').get('name', 'Phalcon Framework') }}">
<meta name="description" content="{{ config.get('app').get('description', '') }}">
<meta name="keyword" content="{{ config.get('app').get('keywords', '') }}">
<meta name="publisher" content="{{ config.get('app').get('name', 'Phalcon Framework') }} Team">
...
<meta property="og:title" content="{{ locale.translate(language, get_title(false)) ~ " - " ~ config.get('app').get('name', 'Phalcon Framework') }}">
...
<meta name="twitter:title" content="{{ locale.translate(language, get_title(false)) ~ " - " ~ config.get('app').get('name', 'Phalcon Framework') }}">
