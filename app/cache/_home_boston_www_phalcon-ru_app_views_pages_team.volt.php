<div class="size-wrap">
    <div class="features-wrap">
        ...
        <div class="title-huge">Phalcon Team</div>

    </div>

    <div class="media">
        <a class="pull-left" href="#">
            <img class="media-object img-circle" data-src="<?php echo $this->url->get('img/team/andres.jpg'); ?>" style="width: 96px;" src="<?php echo $this->url->get('img/team/andres.jpg'); ?>">
        </a>
        ...
        <div class="media-body bio">
            ...
            <p>
                A <a href='http://en.wikipedia.org/wiki/TR35'>TR35</a> winner,
            ...
            <p>
                Andres is one of the core developers of Phalcon and its inspiration.
            </p>
        </div>
    </div>
    <div class="media">
        <a class="pull-left" href="#">
            <img class="media-object img-circle" data-src="<?php echo $this->url->get('img/team/nikos.jpg'); ?>" style="width: 96px;" src="<?php echo $this->url->get('img/team/nikos.jpg'); ?>">
        </a>
        ...
        <div class="media-body bio">
            ...
            <p>
                ...
                out of the norm introduced him to Phalcon. He joined the core team
        ...
        <div class="media">
            <a class="pull-left" href="#">
                <img class="media-object img-circle" data-src="<?php echo $this->url->get('img/team/nikolay.jpg'); ?>" style="width: 96px;" src="<?php echo $this->url->get('img/team/nikolay.jpg'); ?>">
            </a>
