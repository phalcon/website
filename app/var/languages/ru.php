<?php
    ...
    $messages = array(
        ...
        'about_description_2'             => 'Надеемся, что вам нравится Phalcon так же, как и нам. Мы всегда открыты для сотрудничества:',
        ...
        'about_documentation_1'           => 'Репозиторий этого веб-сайта доступен на GitHub. Исправляйте опечатки, добавляйте примеры, статьи и т.д. Кроме того, если вы можете перевести некоторые страницы на другой язык, мы вам будем очень благодарны!',
