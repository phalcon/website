<?php
    ...
    $messages = array(
        ...
        'download_note'                   => 'Phalcon é uma extensão do C, então você precisará baixar um binário para a sua plataforma ou compilá-lo a partir do código fonte.',
        ...
        'download_compilation_11'         => '1. Para criar a extensão do código fonte C siga estes passos:',
        'download_compilation_12'         => '2. Adicione a extensão no seu php.ini:',
        'download_compilation_13'         => '3. Finalmente, restarte o webserver',
        ...
        'download_freebsd_1'              => 'A porta está disponível para FreeBSD. Você só precisa destes poucos comandos para instalá-lo:',
        ...
        'download_windows_note'           => 'Altamente recomendamos que você use a última versão do PHP correspondente à nossas DLLs, de modo a aproveitar o conjunto completo de recursos de Phalcon.',
        ...
        'download_source_code_switch'     => "Código fonte (por favor selecione o ramo pertinente): <a href=':1:' target='_download' title='GitHub Repo'>github</a>",
...
Clientes podem comprar horas de suporte ( mínimo de 2 horas ) à 50 USD por hora.',
        ...
        'sponsors_2'                      => 'Além disso, os clientes podem querer certas funcionalidades implementadas que normalmente levariam muito mais tempo para fazê-lo devido à sua popularidade ou complexidade. Nós certamente podemos acomodar esses pedidos em nossas taxas normais.',
        'contact'                         => 'Contato',
        'contact_1'                       => "Sinta-se livre para <a href=':1:'> contactar-nos </ a> para discutir suas necessidades e permitir-nos oferecer uma solução que melhor atender às suas necessidades e seu orçamento. Nenhum projeto é tão grande ou tão pequeno.",

        'phalcon_team'                    => 'Time Phalcon',
        'team_andres_1'                   => 'Andres não é um  estranho para projetos Open Source. Nos últimos nove anos, ele têm participado de  planejamentos e criações de frameworks para PHP, e têm se envolvido no desenvolvimento web - sua principal paixão.',
        ...
        'about_description_2'             => 'Esperamos que você aprecie Phalcon tanto quanto nós. Nossos braços estão sempre abertos para receber a sua colaboração nas muitas coisas que um projeto como este requer:',
        ...
        'testimonials_2'                  => "Olá, equipe Phalcon. Eu gostaria de compartilhar com vocês a nossa história de sucesso usando Phalcon nos projetos <a href='http://kolesa.kz'> http://kolesa.kz </ a> e <a href='krisha.kz'> krisha.kz </ a>, os sites mais visitados e highloaded no Cazaquistão, classificados em sites de classificação TOP-10 en CIS. Ambos os sites trabalham em única API RESTful, escrita Phalcon \ Mvc \ Micro. Em cargas de pico a API processa algo como 400 req / seg e isso não é um limite. Movendo-se para Phalcon permitiu reduzir o tempo de geração de resposta e o consumo de CPU e de memória RAM, bem como para reduzir o tempo do processo de desenvolvimento. Continuaremos usando Phalcon em nossos novos projetos. Obrigado pelo grande trabalho que estão fazendo! Atenciosamente, Nikita Vershinin, Lead Developer, Kolesa.kz e krisha.kz",
