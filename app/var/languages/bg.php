<?php
    ...
    $messages = array(
        ...
        'store'                           => 'Магазин',
        'github'                          => 'Гит Хъб',
        'phalcon_description'             => "<strong>Phalcon</strong>е уеб фреймуърк имплементиран като екстенжън за С предлагащ <a href=':1:'>high performance</a> и ниска консумация на ресурси

is a web framework implemented as a C extension offering  and lower resource consumption",
        'the_fastest_php_framework'       => 'The fastest<br />PHP Framework',
        'try_online'                      => 'Пробвай онлайн',
        'see_screencasts'                 => 'Виж скрийнкаст',
        'everything_you_need_upper'       => 'ВСИЧКО, ОТ КОЕТО ИМАТЕ НУЖДА',
        'full_mvc_applications'           => "Цели <a href=':1:'>MVC</a> приложения",
        'single_module'                   => 'Едномодулен',
        'multi_module'                    => 'Мултимодулен',
        'micro_applications'              => 'Микро-приложения',
        'orm'                             => 'ООМ (Обектно Ориентиран Модел)',
        ...
        'sharding'                        => 'Шардиране',
        'odm_for_mongo'                   => 'ODM за Mongo',
        'template_engine_volt'            => 'Енджин за шаблони (Volt)',
        'di_ioc'                          => 'DI/IOC',
        'events_management'               => 'Мениджър на събития',
        'encryption'                      => 'Криптиране',
        'http_request'                    => 'HTTP рекуест',
        'http_response'                   => 'Отговор',
        'http_cookies'                    => 'Бисквитки',
        'escaping'                        => 'Избягване',
        'filtering'                       => 'Филтриране',
        'forms_builder'                   => 'Създател на форми',
        'forms_validation'                => 'Валицадия',
        'flash_messages'                  => 'Флаш съобщения',
        'cache'                           => 'Кеш',
        'pagination'                      => 'Пагинация',
        'annotations'                     => 'Анотация',
        'security'                        => 'Сигурност',
        'translations'                    => 'Превод',
        'assets_management'               => 'Мениджмънт на асети',
        'universal_auto_loader'           => 'Универсален ауто-лоудър',
        'cli'                             => 'Команден интерфейс',
        'phalcon_forum_upper'             => 'ФОРУМА НА ФАЛКЪН',
        'stack_overflow_upper'            => 'СТАК ОУВЪРФЛОУ',
        'github_upper'                    => 'ГИТХЪБ',
        'email_us_upper'                  => 'ПИШЕТЕ НИ',
        'services_upper'                  => 'УСЛУГИ',
        'consulting_upper'                => 'КОНСУЛТИРАНЕ',
        'requirements_analysis'           => 'Анализ на изискванията',
        'implementation'                  => 'Имплементация',
        'ongoing_support'                 => 'Продължаваща помощ',
        'read_more'                       => 'Прочети още',
        'hosting_upper'                   => 'ХОСТИНГ',
        'phalcon_can_be_installed'        => 'Фалкън може да бъде инсталиран на',
        'main_upper'                      => 'ГЛАВНА',
        'consulting'                      => 'Консултация',
        'hosting'                         => 'Хостинг',
        'support_upper'                   => 'ПОМОЩ',
        'forum_community'                 => 'Форум / Общност',
        'stack_overflow'                  => 'Стак Оувърфлоу',
        'issue_tracker'                   => 'Тракър на задачи',
        'get_involved_upper'              => 'ВЗЕМИ УЧАСТИЕ',
        'team'                            => 'Тийм',
        'about'                           => 'Относно',
        'roadmap'                         => 'Роудмап',
        'donate_to_phalcon'               => 'Дари на Фалкън',
        'or'                              => 'или',
        'twitter'                         => 'Туитър',
        'facebook'                        => 'Фейсбук',
        'google_plus'                     => 'Гугъл Плюс',
        'vimeo'                           => 'Вимео',
        'amazing_contributors'            => 'Our amazing contributors',

        'download_phalcon'                => 'Свали фалкън',
        'download_linux'                  => 'Линукс/Юникс/Мак',
