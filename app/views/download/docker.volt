...
<p class="download">
    <div class="container">
        ...
        <p>
            Phalcon Compose is very easy to use. Assume that you need to create an application that will be located in: <pre><code class="bash">/home/website</code></pre>
        ...
        <h4>Variables</h4>
        <p>
            You will need to create a new file called <strong>variables.env</strong> in <strong>/home/website</strong>. A sample file has been provided called <strong>variables.env.example</strong>.
            <pre><code class="bash">cd /home/website
cp variables.env.example variables.env
nano variables.env</code></pre>
        Adjust the variables in that file to suit your needs. The most important variable is the <strong>WEB_ALIAS_DOMAIN</strong>. Change the name to something you will be able to use. In our case we just leave the default called <strong>phalcon.local</strong>.
        </p>
        <p>
